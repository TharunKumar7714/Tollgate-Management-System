...
<center>
 <h1>TollGate Management</h1>
  ...
  <tr>
    ...
    <table align="center">
      <tr>
        <td width="290" class="userlogin" align="center" background="images/bg_thead.gif">Admin Login Here</td>
      </tr>
    </table>
  ...
  <tr>
    <td ></td>
    <td ><input type="submit" name="su"  value="Login"> &nbsp;&nbsp;&nbsp;<input name="reset"  type="reset"  value="Clear">
  </td>
  </tr>	
  </table>
  </td>
